...
\hline
\end{xltabular}
\hinweis{Warnung}{Zwängung auf Normalkraft – 3. Lage: nicht erfüllt. N\_s,adm = 754 mm² · 466 N/mm² = 351.6 kN < N\_Riss = 378.3 kN.}
\subsection{Dach}
\noindent\textbf{Angaben zur Platte}
\begin{equation*}
...
\hinweis{Warnung}{Stahlspannung aus Rissbreite – Dauerlast: nicht erfüllt. ε\_m = 2.3198 ‰, χ = 0.03612 1/m. Stahl fliesst (ε\_s = 4.67 ‰ > ε\_y = 2.50 ‰): ε\_s > ε\_s,adm = 2.50 ‰.}
\hinweis{Hinweis}{Zwängung auf Normalkraft – 1. Lage: nicht erfüllt (α\_eff = 0.99), ausgeschaltet. N\_s,adm = 262 mm² · 500 N/mm² = 130.9 kN < N\_Riss = 131.8 kN.}
\subsection{Ohne x}
\noindent\textbf{Angaben zur Platte}
\begin{equation*}
