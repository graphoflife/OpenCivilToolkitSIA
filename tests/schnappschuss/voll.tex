...
\end{equation*}
\noindent\textbf{Bügelteilung in y-Richtung}
\begin{equation*}
...
\end{equation*}
\noindent\textbf{Statische Höhe der gezogenen Bewehrung (unten)}
\begin{equation*}
d = 249.0\,\mathrm{mm}
\end{equation*}
...
\end{equation*}
\noindent\textbf{Statische Höhe der gezogenen Bewehrung (oben)}
\begin{equation*}
d = 252.0\,\mathrm{mm}
\end{equation*}
Zwischen α = 30° und α = 45° ganzgradig durchgerechnet; den grössten Widerstand liefert α = 30°.
...
\end{equation*}
\noindent\textbf{Bezogene Druckzonenhöhe}
\begin{equation*}
...
\noindent\textbf{Statische Höhe ab der gedrückten Randfaser (unten)}
\begin{equation*}
...
\noindent\textbf{Statische Höhe ab der gedrückten Randfaser (oben)}
\begin{equation*}
...
\begin{equation*}
\begin{array}{rrrrr}
k & e_{2d}^{(k-1)}\ [\mathrm{mm}] & M_{Ed,II}^{(k)}\ [\mathrm{kNm}] & \chi^{(k)}\ [\mathrm{m}^{-1}] & e_{2d}^{(k)}\ [\mathrm{mm}] \\ \hline
...
\begin{array}{lllrrrrr}
\text{Bewehrung} & \text{Richtung} & \text{Stahl} & \varnothing\ [\mathrm{mm}] & s\ [\mathrm{mm}] & \text{Randabstand}\ [\mathrm{mm}] & d\ [\mathrm{mm}] & A_s\ [\mathrm{mm}^2] \\ \hline
\text{1. Lage Grundbewehrung} & \text{x} & \text{B500B} & 10 & 150 & 35 & 165 & 524 \\
\text{2. Lage Grundbewehrung} & \text{y} & \text{B500B} & 8 & 150 & 44 & 156 & 335 \\
\text{3. Lage Grundbewehrung} & \text{y} & \text{B500B} & 8 & 150 & 44 & 44 & 335 \\
\text{4. Lage Grundbewehrung} & \text{x} & \text{B500B} & 10 & 150 & 35 & 35 & 524 \\
\end{array}
\end{equation*}
\subsection{Resistenzlinie aus Handrechnung – x-Richtung}
Druckzone als Spannungsblock der Höhe 0.85·x mit durchgehend f\_cd; gedrückter Stahl bleibt unberücksichtigt. Die Bewehrung ist je Seite zu einer Lage zusammengefasst, das Moment bezieht sich auf die halbe Querschnittshöhe.
...
\begin{array}{lrrr}
\text{Seite} & A_s\ [\mathrm{mm}^2] & d\ [\mathrm{mm}] & f_{yd}\ [\mathrm{N/mm^2}] \\ \hline
\text{1. Lage Grundbewehrung} & 524 & 165.0 & 435 \\
\text{4. Lage Grundbewehrung} & 524 & 35.0 & 435 \\
\end{array}
\end{equation*}
\subsubsection{Grösste Druckkraft}
\noindent\textbf{Gleichmässiger Druck, ohne Bewehrung}
...
\midrule
\endhead
M-N-Nachweis x – Feld & $1.57$ & \textcolor{green!50!black}{erfüllt} \\
M-N-Nachweis x – Feld mit Druck & $2.12$ & \textcolor{green!50!black}{erfüllt} \\
M-N-Nachweis x – Stütze & $1.33$ & \textcolor{green!50!black}{erfüllt} \\
M-N-Nachweis x – Feld & $0.45$ & \textcolor{red}{\textbf{nicht erfüllt}} \\
Querkraft x – Feld & $2.65$ & \textcolor{green!50!black}{erfüllt} \\
Querkraft x – Stütze & $3.58$ & \textcolor{green!50!black}{erfüllt} \\
Duktilität – 2. Lage & $1.39$ & \textcolor{green!50!black}{erfüllt} \\
M-N x – Feld & $0.00$ & \textcolor{red}{\textbf{nicht erfüllt}} \\
V x – Feld & $0.00$ & \textcolor{red}{\textbf{nicht erfüllt}} \\
Rissnormalkraft x – 3. Lage & $0.93$ & \textcolor{red}{\textbf{nicht erfüllt}} \\
Sprödes Versagen x – 3. Lage & $1.93$ & \textcolor{green!50!black}{erfüllt} \\
Zwängung Biegung x – 3. Lage & $1.94$ & \textcolor{green!50!black}{erfüllt} \\
Stahlspannung (Rissbreite) x – Feld (60 \%) & $2.18$ & \textcolor{green!50!black}{erfüllt} \\
Stahlspannung (Rissbreite) x – Feld mit Druck (60 \%) & $3.60$ & \textcolor{green!50!black}{erfüllt} \\
Stahlspannung (Rissbreite) x – Stütze (60 \%) & $1.79$ & \textcolor{green!50!black}{erfüllt} \\
Stahlspannung (Rissbreite) x – Dauerlast & $2.80$ & \textcolor{green!50!black}{erfüllt} \\
Stahlspannung (Rissbreite) x – Dauerlast & $0.54$ & \textcolor{red}{\textbf{nicht erfüllt}} \\
Stahlspannung x – Feld (70 \%) & $1.74$ & \textcolor{green!50!black}{erfüllt} \\
Stahlspannung x – Feld mit Druck (70 \%) & $2.88$ & \textcolor{green!50!black}{erfüllt} \\
Stahlspannung x – Stütze (70 \%) & $1.43$ & \textcolor{green!50!black}{erfüllt} \\
Stahlspannung x – Gebrauch & $2.03$ & \textcolor{green!50!black}{erfüllt} \\
Knicken – Wand & $4.88$ & \textcolor{green!50!black}{erfüllt} \\
\bottomrule
\end{longtable}
\noindent \textbf{Mindestens ein Nachweis ist nicht erfüllt.}

\vspace{0.6em}
\noindent\footnotesize
\textit{Nicht geführte Nachweise, die mit der vorliegenden Bewehrung nicht aufgehen:}\begin{itemize}\setlength{\itemsep}{0pt}
\item Rissnormalkraft x – 1. Lage -- $\alpha_{eff} = 0.99$. A\_s = 524 mm² bei σ\_s,adm = 500 N/mm² ergibt N\_s,adm = 261.8 kN gegen N\_Riss = 263.6 kN.
\end{itemize}
\normalsize
...
Querschnitt eines Bügelschenkels & $A_{\varnothing,V}$ & 50.3 & mm\textasciicircum{}2 & berechnet \\
Grösste Neigung der Druckdiagonalen & $\alpha_{max}$ & 45 & Grad & Vorgabe \\
Kleinste Neigung der Druckdiagonalen & $\alpha_{min}$ & 30 & Grad & Vorgabe \\
...
Betrachtete Breite (x) & $b$ & 1000 & mm & Vorgabe \\
Betrachtete Breite (y) & $b_y$ & 1000 & mm & Vorgabe \\
Bewehrungsmass je Kubikmeter Beton & $\mu_s$ & 67 & kg/m\textasciicircum{}3 & berechnet \\
Überdeckung oben & $c_{nom,o}$ & 30 & mm & Vorgabe \\
Überdeckung unten & $c_{nom,u}$ & 30 & mm & Vorgabe \\
Höhe der Distanzhalter (OK innere untere bis UK innere obere Lage) & $h_{Dist}$ & 104 & mm & berechnet \\
Plattendicke & $h$ & 200 & mm & Vorgabe \\
Kriechzahl & $\varphi$ & 2 &  & Vorgabe \\
Bewehrungsquerschnitt 1. Lage Grundbewehrung & $A_{s,1,x,g}$ & 524 & mm\textasciicircum{}2 & berechnet \\
...
Bewehrungsquerschnitt 2. Lage Grundbewehrung & $A_{s,2,y,g}$ & 335 & mm\textasciicircum{}2 & berechnet \\
...
Bewehrungsquerschnitt 3. Lage Grundbewehrung & $A_{s,3,y,g}$ & 335 & mm\textasciicircum{}2 & berechnet \\
...
Bewehrungsquerschnitt 4. Lage Grundbewehrung & $A_{s,4,x,g}$ & 524 & mm\textasciicircum{}2 & berechnet \\
