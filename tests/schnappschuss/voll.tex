...
\end{equation*}
\noindent\textbf{Bewehrungsquerschnitt über die Breite b} \hfill \normref{SIA 262:2025, 5.5.2}
\begin{equation*}
...
\end{aligned}
\end{equation*}
\noindent\textbf{Nulllinie auf halber Höhe}
\begin{equation*}
x^{+} = \frac{h}{2} = \frac{300\,\mathrm{mm}}{2} = 150\,\mathrm{mm}
\end{equation*}
\noindent\textbf{Dehnung der Zugbewehrung}
\begin{equation*}
...
\end{equation*}
\noindent\textbf{Stahlspannung, höchstens die Fliessgrenze}
\begin{equation*}
\begin{aligned}
...
\end{equation*}
\subsubsection{Nachweis – Schräg}
\noindent\textbf{Einwirkung}
\begin{equation*}
M_{Ed} = 30\,\mathrm{kNm} \qquad N_{Ed} = -500\,\mathrm{kN}
\end{equation*}
\noindent\textbf{Bezugsgrösse der Normalkraft}
\begin{equation*}
\begin{aligned}
...
\end{aligned}
\end{equation*}
\noindent\textbf{Bezugsgrösse des Moments}
\begin{equation*}
\begin{aligned}
...
\end{aligned}
\end{equation*}
\noindent\textbf{Einwirkung im normierten Diagramm}
\begin{equation*}
...
\end{equation*}
\noindent\textbf{Nächster Punkt P der Resistenzlinie}
\begin{equation*}
N_P = 160.8\,\mathrm{kN} \qquad M_P = 38.6\,\mathrm{kNm}
\end{equation*}
\noindent\textbf{Kürzester Abstand zur Resistenzlinie}
\begin{equation*}
\begin{aligned}
...
\end{aligned}
\end{equation*}
\noindent\textbf{Widerstand im normierten Diagramm}
\begin{equation*}
...
\subsection{Analytische Gleichungen – Vorbemessung}
Stütze 30 × 30 cm, zentrisch.

\begin{equation*}
a = 30\,\mathrm{cm}
\end{equation*}
\noindent\textbf{Bemessungswert der Betondruckfestigkeit}
\begin{equation*}
...
\end{equation*}
\hinweis{Warnung}{Zeile 6: Einheiten passen nicht zusammen.}
\section{Verwendete Formeln}
\subsection{Querschnitt}
\noindent\textbf{Bewehrungsquerschnitt über die Breite b} \hfill \normref{SIA 262:2025, 5.5.2}
\begin{equation*}
A_s = \frac{\pi \cdot \varnothing^{2}}{4} \cdot \frac{b}{s}
\end{equation*}
...
f_{yd}^{-} = \frac{f_{yk}^{-}}{\gamma_s}
\end{equation*}
\subsection{Biegung und Normalkraft}
...
d_{3,x} = h - z_{3,x}
\end{equation*}
\noindent\textbf{Widerstand bei N\_Ed – ein Eckpunkt liegt genau dort}
\begin{equation*}
M_{Rd} = M_{Rd}(N_{Ed}=0)^{+}
\end{equation*}
\noindent\textbf{Erfüllungsgrad}
...
\end{equation*}
\noindent\textbf{Widerstand bei festgehaltenem N\_Ed}
\begin{equation*}
M_{Rd} = M_1 + \frac{N_{Ed} - N_1}{N_2 - N_1} \cdot \left(M_2 - M_1\right)
\end{equation*}
\noindent\textbf{Bezugsgrösse der Normalkraft}
...
\end{equation*}
\subsection{Zwängung auf Normalkraft}
...
\end{equation*}
\noindent\textbf{Zulässige Stahlspannung (Rissbreite w\_nom)} \hfill \normref{SIA 262:2025, 4.4.2}
\begin{equation*}
\sigma_{s,adm,2,x} = \min\left[\sqrt{\frac{9 \cdot E_s \cdot f_{ctm} \cdot w_{nom}}{\varnothing_{2,x}}};\ f_{yk}\right]
\end{equation*}
\noindent\textbf{Aufnehmbare Risskraft}
...
\end{equation*}
\subsection{Zwängung auf Biegung}
...
M_{s,adm,2,x} = \sigma_{s,adm,2,x} \cdot A_{s,2,x} \cdot z
\end{equation*}
\subsection{Stahlspannung aus Rissbreite}
...
\varepsilon_{s,adm} = \frac{\sigma_{s,adm}}{E_s}
\end{equation*}
\subsection{Stahlspannung gegen Fliessen}
...
\hline
\end{xltabular}
\hinweis{Warnung}{Risse: Zwängung Normalkraft – 3. Lage: nicht erfüllt. N\_s,adm = 754 mm² · 466 N/mm² = 351.6 kN < N\_Riss = 378.3 kN.}
\subsection{Dach}
\noindent\textbf{Angaben zur Platte}
\begin{equation*}
...
\hline
\end{xltabular}
\hinweis{Warnung}{Biegung und Normalkraft – Feld: nicht erfüllt. M\_Rd = 18.1 kNm bei N\_Ed = 0 kN.}
\hinweis{Warnung}{Risse: Quasi-ständige Lastfälle – Dauerlast: nicht erfüllt. ε\_m = 2.3198 ‰, χ = 0.03612 1/m. Stahl fliesst (ε\_s = 4.67 ‰ > ε\_y = 2.50 ‰): ε\_s > ε\_s,adm = 2.50 ‰.}
\hinweis{Hinweis}{Risse: Zwängung Normalkraft – 1. Lage: nicht erfüllt (α\_eff = 0.99), ausgeschaltet. N\_s,adm = 262 mm² · 500 N/mm² = 130.9 kN < N\_Riss = 131.8 kN.}
\subsection{Ohne x}
\noindent\textbf{Angaben zur Platte}
\begin{equation*}
...
\hline
\end{xltabular}
\hinweis{Hinweis}{Biegung und Normalkraft – Feld, Querkraft – Feld: Keine Bewehrung in x-Richtung → Widerstand 0, nicht erfüllt.}
\subsection{Konsole}
\noindent\textbf{Angaben zur Platte}
\begin{equation*}
\text{Beton C30/37} \qquad h = 250\,\mathrm{mm} \qquad b_x = 1000\,\mathrm{mm}
