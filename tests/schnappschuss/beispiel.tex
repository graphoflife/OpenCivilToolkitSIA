...
Momentenwiderstand bei N\_Ed (x-Richtung) – Feld & $M_{Rd,x}(N_{Ed})_{Feld}$ & 235.9 & kNm & berechnet \\
Erfüllungsgrad x-Richtung – Feld & $\alpha_{eff,x,Feld}$ & 2.359 &  & berechnet \\
Momentenwiderstand bei N\_Ed (x-Richtung) – Feld mit Druck & $M_{Rd,x}(N_{Ed})_{Feld_mit_Druck}$ & 253.8 & kNm & berechnet \\
Erfüllungsgrad x-Richtung – Feld mit Druck & $\alpha_{eff,x,Feld_mit_Druck}$ & 2.538 &  & berechnet \\
...
Momentenwiderstand bei N\_Ed (x-Richtung) – Stütze & $M_{Rd,x}(N_{Ed})_{Stütze}$ & 79.9 & kNm & berechnet \\
Erfüllungsgrad x-Richtung – Stütze & $\alpha_{eff,x,Stütze}$ & 1.598 &  & berechnet \\
