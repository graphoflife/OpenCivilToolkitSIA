...
$$
\mu_s = \frac{A_{s,tot} \cdot 7850\,\mathrm{kg}/\mathrm{m}^{3}}{b \cdot h} = \frac{1717.4\,\mathrm{mm}^{2} \cdot 7850\,\mathrm{kg}/\mathrm{m}^{3}}{1000\,\mathrm{mm} \cdot 200\,\mathrm{mm}} = 67\,\mathrm{kg}/\mathrm{m}^{3}
$$
...
$$
\alpha_{eff} = \frac{M_{Rd}}{M_{Ed}} = \frac{36.3}{20.0} = 1.81 \quad \Rightarrow \quad \text{erfüllt}
$$
...
$$
\mu_s = \frac{A_{s,tot} \cdot 7850\,\mathrm{kg}/\mathrm{m}^{3}}{b \cdot h} = \frac{2555.16\,\mathrm{mm}^{2} \cdot 7850\,\mathrm{kg}/\mathrm{m}^{3}}{1000\,\mathrm{mm} \cdot 250\,\mathrm{mm}} = 80\,\mathrm{kg}/\mathrm{m}^{3}
$$

**Höhe der Distanzhalter**

$$
h_{Dist} = \text{OK innere untere Lage} - \text{UK innere obere Lage} = 198.0\,\mathrm{mm} - 52.0\,\mathrm{mm} = 146.0\,\mathrm{mm}
$$
...
$$
\alpha_{eff} = \frac{M_{Rd}}{M_{Ed}} = \frac{64.2}{40.0} = 1.60 \quad \Rightarrow \quad \text{erfüllt}
$$
