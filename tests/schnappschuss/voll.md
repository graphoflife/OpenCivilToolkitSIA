...
75 Berechnungen ausgeführt, 136 Werte bestimmt.
...
$$
\alpha_{eff} = \frac{M_{Rd}}{M_{Ed}} = \frac{235.9}{150.0} = 1.57 \quad \Rightarrow \quad \text{erfüllt}
$$
...
$$
\alpha_{eff} = \frac{M_{Rd}}{M_{Ed}} = \frac{253.8}{120.0} = 2.12 \quad \Rightarrow \quad \text{erfüllt}
$$
...
$$
\alpha_{eff} = \frac{M_{Rd}}{M_{Ed}} = \frac{79.9}{60.0} = 1.33 \quad \Rightarrow \quad \text{erfüllt}
$$
...
**Bügelteilung in y-Richtung**

$$
s_{V,y} = 200\,\mathrm{mm}
$$
...
\begin{aligned}
  ...
  &= \frac{\pi \cdot \left(8\,\mathrm{mm}\right)^{2}}{4} \\
  &= 50.3\,\mathrm{mm}^{2}
\end{aligned}
$$
...
$$
d_{2,x} = \frac{\sum A_{s,i} \cdot z_i}{\sum A_{s,i}} = 248.1\,\mathrm{mm}
$$
...
= \frac{2450\,\mathrm{mm}^{2} \cdot 434.8\,\mathrm{N}/\mathrm{mm}^{2}}{0.85 \cdot 1000\,\mathrm{mm} \cdot 20.0\,\mathrm{N}/\mathrm{mm}^{2}} = 62.7\,\mathrm{mm}
$$

**Bezogene Druckzonenhöhe**

$$
\frac{x}{d_{2,x}} = \frac{62.7\,\mathrm{mm}}{248.1\,\mathrm{mm}} = 0.253 \quad \le \quad 0.35 \quad \Rightarrow \quad \text{erfüllt}
$$

**Erfüllungsgrad**

$$
\alpha_{eff,D,2} = \frac{0.35}{x/d_{2,x}} = \frac{0.35}{0.253} = 1.39
$$
...
$$
d_{3,x,g} = h - z = 252.0\,\mathrm{mm}
$$

**Druckzonenhöhe bei reiner Biegung**

$$
x = \frac{A_{s,3,x,g} \cdot f_{sd}}{0.85 \cdot b \cdot f_{cd}}
= \frac{754\,\mathrm{mm}^{2} \cdot 434.8\,\mathrm{N}/\mathrm{mm}^{2}}{0.85 \cdot 1000\,\mathrm{mm} \cdot 20.0\,\mathrm{N}/\mathrm{mm}^{2}} = 19.3\,\mathrm{mm}
$$

**Bezogene Druckzonenhöhe**

$$
\frac{x}{d_{3,x,g}} = \frac{19.3\,\mathrm{mm}}{252.0\,\mathrm{mm}} = 0.077 \quad \le \quad 0.35 \quad \Rightarrow \quad \text{erfüllt}
$$

**Erfüllungsgrad**

$$
\alpha_{eff,D,3} = \frac{0.35}{x/d_{3,x,g}} = \frac{0.35}{0.077} = 4.57
$$
...
$$
E_{c,eff} = \frac{E_{cm}}{1 + \varphi} = \frac{33620\,\mathrm{N}/\mathrm{mm}^{2}}{1 + 2.00} = 11207\,\mathrm{N}/\mathrm{mm}^{2} \qquad n = 17.85
$$
...
$$
N_{int} = -0.0\,\mathrm{kN} \;\checkmark \qquad M_{int} = 90.0\,\mathrm{kNm} \;\checkmark
$$

**Grösste Zugspannung in der Bewehrung**

$$
\sigma_s = 175\,\mathrm{N}/\mathrm{mm}^{2} \quad \le \quad \sigma_{s,adm} = 381\,\mathrm{N}/\mathrm{mm}^{2} \quad \Rightarrow \quad \text{erfüllt}
$$

**Erfüllungsgrad**

$$
\alpha_{eff,\sigma} = \frac{\sigma_{s,adm}}{\sigma_s} = \frac{381\,\mathrm{N}/\mathrm{mm}^{2}}{175\,\mathrm{N}/\mathrm{mm}^{2}} = 2.18
$$
...
$$
N_{int} = -180.0\,\mathrm{kN} \;\checkmark \qquad M_{int} = 72.0\,\mathrm{kNm} \;\checkmark
$$

**Grösste Zugspannung in der Bewehrung**

$$
\sigma_s = 106\,\mathrm{N}/\mathrm{mm}^{2} \quad \le \quad \sigma_{s,adm} = 381\,\mathrm{N}/\mathrm{mm}^{2} \quad \Rightarrow \quad \text{erfüllt}
$$

**Erfüllungsgrad**

$$
\alpha_{eff,\sigma} = \frac{\sigma_{s,adm}}{\sigma_s} = \frac{381\,\mathrm{N}/\mathrm{mm}^{2}}{106\,\mathrm{N}/\mathrm{mm}^{2}} = 3.60
$$
...
$$
N_{int} = 0.0\,\mathrm{kN} \;\checkmark \qquad M_{int} = -36.0\,\mathrm{kNm} \;\checkmark
$$

**Grösste Zugspannung in der Bewehrung**

$$
\sigma_s = 212\,\mathrm{N}/\mathrm{mm}^{2} \quad \le \quad \sigma_{s,adm} = 381\,\mathrm{N}/\mathrm{mm}^{2} \quad \Rightarrow \quad \text{erfüllt}
$$

**Erfüllungsgrad**

$$
\alpha_{eff,\sigma} = \frac{\sigma_{s,adm}}{\sigma_s} = \frac{381\,\mathrm{N}/\mathrm{mm}^{2}}{212\,\mathrm{N}/\mathrm{mm}^{2}} = 1.79
$$
...
$$
\varepsilon_m = 0.2120\,\text{‰} \qquad \chi = 0.00472\,\mathrm{m}^{-1} \qquad \varepsilon(z) = \varepsilon_m + \chi \cdot \left(z - \tfrac{h}{2}\right)
$$

**Probe: die Ebene erzeugt die Einwirkung**

$$
N_{int} = -0.0\,\mathrm{kN} \;\checkmark \qquad M_{int} = 70.0\,\mathrm{kNm} \;\checkmark
$$

**Grösste Zugspannung in der Bewehrung**

$$
\sigma_s = 136\,\mathrm{N}/\mathrm{mm}^{2} \quad \le \quad \sigma_{s,adm} = 381\,\mathrm{N}/\mathrm{mm}^{2} \quad \Rightarrow \quad \text{erfüllt}
$$

**Erfüllungsgrad**

$$
\alpha_{eff,\sigma} = \frac{\sigma_{s,adm}}{\sigma_s} = \frac{381\,\mathrm{N}/\mathrm{mm}^{2}}{136\,\mathrm{N}/\mathrm{mm}^{2}} = 2.80
$$
...
$$
\varepsilon_m = 0.3180\,\text{‰} \qquad \chi = 0.00709\,\mathrm{m}^{-1} \qquad \varepsilon(z) = \varepsilon_m + \chi \cdot \left(z - \tfrac{h}{2}\right)
$$

**Probe: die Ebene erzeugt die Einwirkung**

$$
N_{int} = -0.0\,\mathrm{kN} \;\checkmark \qquad M_{int} = 105.0\,\mathrm{kNm} \;\checkmark
$$

**Grösste Zugspannung in der Bewehrung**

$$
\sigma_s = 204\,\mathrm{N}/\mathrm{mm}^{2} \quad \le \quad \sigma_{s,adm} = 355\,\mathrm{N}/\mathrm{mm}^{2} \quad \Rightarrow \quad \text{erfüllt}
$$

**Erfüllungsgrad**

$$
\alpha_{eff,\sigma} = \frac{\sigma_{s,adm}}{\sigma_s} = \frac{355\,\mathrm{N}/\mathrm{mm}^{2}}{204\,\mathrm{N}/\mathrm{mm}^{2}} = 1.74
$$
...
$$
N_{int} = -210.0\,\mathrm{kN} \;\checkmark \qquad M_{int} = 84.0\,\mathrm{kNm} \;\checkmark
$$

**Grösste Zugspannung in der Bewehrung**

$$
\sigma_s = 123\,\mathrm{N}/\mathrm{mm}^{2} \quad \le \quad \sigma_{s,adm} = 355\,\mathrm{N}/\mathrm{mm}^{2} \quad \Rightarrow \quad \text{erfüllt}
$$

**Erfüllungsgrad**

$$
\alpha_{eff,\sigma} = \frac{\sigma_{s,adm}}{\sigma_s} = \frac{355\,\mathrm{N}/\mathrm{mm}^{2}}{123\,\mathrm{N}/\mathrm{mm}^{2}} = 2.88
$$
...
$$
N_{int} = -0.0\,\mathrm{kN} \;\checkmark \qquad M_{int} = -42.0\,\mathrm{kNm} \;\checkmark
$$

**Grösste Zugspannung in der Bewehrung**

$$
\sigma_s = 248\,\mathrm{N}/\mathrm{mm}^{2} \quad \le \quad \sigma_{s,adm} = 355\,\mathrm{N}/\mathrm{mm}^{2} \quad \Rightarrow \quad \text{erfüllt}
$$

**Erfüllungsgrad**

$$
\alpha_{eff,\sigma} = \frac{\sigma_{s,adm}}{\sigma_s} = \frac{355\,\mathrm{N}/\mathrm{mm}^{2}}{248\,\mathrm{N}/\mathrm{mm}^{2}} = 1.43
$$
...
$$
\sigma_s = 175\,\mathrm{N}/\mathrm{mm}^{2} \quad \le \quad \sigma_{s,adm} = 355\,\mathrm{N}/\mathrm{mm}^{2} \quad \Rightarrow \quad \text{erfüllt}
$$

**Erfüllungsgrad**

$$
\alpha_{eff,\sigma} = \frac{\sigma_{s,adm}}{\sigma_s} = \frac{355\,\mathrm{N}/\mathrm{mm}^{2}}{175\,\mathrm{N}/\mathrm{mm}^{2}} = 2.03
$$
...
\begin{aligned}
  \mu_s &= \frac{A_{s,tot} \cdot 7850\,\mathrm{kg}/\mathrm{m}^{3}}{b \cdot h} \\
  &= \frac{1717.4\,\mathrm{mm}^{2} \cdot 7850\,\mathrm{kg}/\mathrm{m}^{3}}{1000\,\mathrm{mm} \cdot 200\,\mathrm{mm}} \\
  &= 67\,\mathrm{kg}/\mathrm{m}^{3}
\end{aligned}
$$
...
$$
h_{Dist} = \text{OK innere untere Lage} - \text{UK innere obere Lage} = 152.0\,\mathrm{mm} - 48.0\,\mathrm{mm} = 104.0\,\mathrm{mm}
$$
...
\begin{aligned}
  N_{Rd}^{-} &= -b \cdot h \cdot f_{cd} \\
  &= -1000\,\mathrm{mm} \cdot 200\,\mathrm{mm} \cdot 20\,\mathrm{N}/\mathrm{mm}^{2} \\
  &= -4000\,\mathrm{kN}
\end{aligned}
$$
...
$$
\begin{aligned}
  x^{+} &= \frac{A_{s,1,x} \cdot f_{yd}}{0.85 \cdot b \cdot f_{cd}} \\
  &= \frac{524\,\mathrm{mm}^{2} \cdot 435\,\mathrm{N}/\mathrm{mm}^{2}}{0.85 \cdot 1000\,\mathrm{mm} \cdot 20\,\mathrm{N}/\mathrm{mm}^{2}} \\
  &= 13.4\,\mathrm{mm}
\end{aligned}
$$
...
$$
\begin{aligned}
  \varepsilon_s^{+} &= \left(d_{1,x} - x^{+}\right) \cdot \frac{\varepsilon_{c2d}}{x^{+}} \\
  &= \left(165\,\mathrm{mm} - 100\,\mathrm{mm}\right) \cdot \frac{3.5\,\text{‰}}{100\,\mathrm{mm}} \\
  &= 2.27\,\text{‰}
\end{aligned}
$$
...
$$
\begin{aligned}
  x^{-} &= \frac{A_{s,4,x} \cdot f_{yd}}{0.85 \cdot b \cdot f_{cd}} \\
  &= \frac{524\,\mathrm{mm}^{2} \cdot 435\,\mathrm{N}/\mathrm{mm}^{2}}{0.85 \cdot 1000\,\mathrm{mm} \cdot 20\,\mathrm{N}/\mathrm{mm}^{2}} \\
  &= 13.4\,\mathrm{mm}
\end{aligned}
$$
...
$$
\begin{aligned}
  \varepsilon_s^{-} &= \left(d_{4,x} - x^{-}\right) \cdot \frac{\varepsilon_{c2d}}{x^{-}} \\
  &= \left(165\,\mathrm{mm} - 100\,\mathrm{mm}\right) \cdot \frac{3.5\,\text{‰}}{100\,\mathrm{mm}} \\
  &= 2.27\,\text{‰}
\end{aligned}
$$
...
$$
\alpha_{eff} = \frac{M_{Rd}}{M_{Ed}} = \frac{36.3}{80.0} = 0.45 \quad \Rightarrow \quad \text{NICHT erfüllt}
$$
...
$$
N_{int} = -0.0\,\mathrm{kN} \;\checkmark \qquad M_{int} = 40.0\,\mathrm{kNm} \;\checkmark
$$
...
$$
\varepsilon_s = 4.67\,\text{‰} \quad > \quad \varepsilon_{y} = \frac{f_{yk}}{E_s} = 2.50\,\text{‰}
$$

**Zulässige Dehnung**

$$
\varepsilon_{s,adm} = \frac{\sigma_{s,adm}}{E_s} = 2.50\,\text{‰} \qquad \varepsilon_s = 4.67\,\text{‰} \quad > \quad \varepsilon_{s,adm} \quad \Rightarrow \quad \text{NICHT erfüllt}
$$

**Erfüllungsgrad**

$$
\alpha_{eff,\sigma} = \frac{\varepsilon_{s,adm}}{\varepsilon_s} = \frac{2.50\,\text{‰}}{4.67\,\text{‰}} = 0.54
$$
...
| Querkraftbewehrung | x/y | $\varnothing 8@200@200$ | B500B |
...
| Bügelteilung in y-Richtung | $s_{V,y}$ | $200$ | mm | Vorgabe |
| Betrachtete Breite (x) | $b$ | $1000$ | mm | Vorgabe |
| Betrachtete Breite (y) | $b_y$ | $1000$ | mm | Vorgabe |
